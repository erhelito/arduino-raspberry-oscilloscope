###############################
###############################
# change the way x axis is displayed / computed
...
time_scale = 3 # Time scale for the x-axis in seconds
...
def update(frame):
    ...
    time = [i*(time_scale/len(data1)) for i in range(len(data1))]  # Generate time values 
